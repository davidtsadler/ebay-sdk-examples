 ...
 */
$request = new Types\GetACategoryTreeRestRequest();

/**
 * Note how URI parameters are just properties on the request object.
 */
$request->category_tree_id = '0';

/**
 * Send the request.
 */
$response = $service->getACategoryTree($request);
