 ...
 */
use \DTS\eBaySDK\Metadata\Services;
use \DTS\eBaySDK\Metadata\Types;
use \DTS\eBaySDK\Metadata\Enums;
 ...
 */
$request = new Types\GetPoliciesForItemConditionRestRequest();

/**
 * Note how URI parameters are just properties on the request object.
 */
$request->marketplace_id = 'EBAY-US';

/**
 * Send the request.
 */
$response = $service->getPoliciesForItemCondition($request);
